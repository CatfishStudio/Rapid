...
namespace Rapid
{
	partial class FormClientPlanAccounts
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormClientPlanAccounts));
			...
			this.Name = "FormClientPlanAccounts";
			this.Text = "План счетов:";
			this.Closed += new System.EventHandler(this.FormClientPlanAccountsClosed);
			this.Load += new System.EventHandler(this.FormClientPlanAccountsLoad);
