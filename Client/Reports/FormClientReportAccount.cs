...
namespace Rapid
{
	...
	public partial class FormClientReportAccount : Form
	{
		...
		void Button1Click(object sender, EventArgs e)
		{
			...
			//_mySQL.SelectSqlCommand = "SELECT * FROM operations WHERE (operations_date BETWEEN '" + dateTimePicker1.Text + "' AND '" + dateTimePicker2.Text + "' AND operations_DT = " + textBox3.Text + " OR operations_KT = " + textBox3.Text + ") ORDER BY operations_date ASC";
